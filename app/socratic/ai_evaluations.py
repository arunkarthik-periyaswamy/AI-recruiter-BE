...
gpt_prompt = {"role": "system",
              "content": """You are a evaluator who evaluates the users conversation for the initial question asked which was why is the sky blue?
- you will rate the accuracy and correctness of the response in the scale of low, average, high.
...
def ai_eval_score_generator(question, conversation):
